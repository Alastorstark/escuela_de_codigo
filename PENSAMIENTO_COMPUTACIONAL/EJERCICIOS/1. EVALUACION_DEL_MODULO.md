...
ENTRADA -- PROCESO -- SALIDA?(valor 0.5)si


3. ¿Al diseñar un algoritmo se deben tener presente las características de precisión, definición y finitud?(valor 0.5)si
...
4. De las siguientes descripciones, menciona cuál es un algoritmo cualitativo y cuál es un algoritmo cuantitativo:
      ...
      b) El proceso de calcular la edad de una persona sabiendo su fecha de nacimiento.(valor0. 5)cualitatvos

      c) Sumar cuántos comentarios tuvo una publicación en alguna red social. (valor 0.5)cuantitatios

      d) El proceso que seguiste para inscribirte a la Escuela de Códigos. (valor 0.5)cuantitativos
...
secamos el agua de nuestras manos. ¡Listos! Tenemos nuestras manos limpias.
    ...
    Entrada: Para lavarse las manos necesitamos: un jabón, un recipiente con agua, una toalla y nuestras manos. Tomamos el recipiente con agua y vaciamos un poco para humedecer
nuestras manos.
...
por cada respuesta correcta de la tabla )
    ...
    indicarle a la computadora lo que debe                               lenguaje de programación   
...
Indica que tipo de variable es en cada caso: (valor 0.3 por cada uno)
    ...
    13. suma = a + b/ c                    numericas

    14. interrup = true                    trabajo

    15. apellido= ‘lopez’                  trabajo

    16. x = x + 1                          logica

    17. suma = suma + num                  numerca

    18. c = sqrt(a*a + b*b)                cadena
